                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: Dimensions.space5),
                        Text('${controller.currencySymbol}${Converter.formatNumber(controller.planList[widget.index].minimumAmount ?? "0.00").makeCurrencyComma()}',
                    ...
                    Column(
                      ...
                      children: [
                        Text(MyStrings.maxAmount,
                            style: interRegularSmall.copyWith(color: MyColor.smallTextColor1, fontSize: Dimensions.fontSmall12, fontWeight: FontWeight.w400)),
                        const SizedBox(height: Dimensions.space5),
                        Text('${controller.currencySymbol}${Converter.formatNumber(controller.planList[widget.index].maximumAmount ?? "0.00").makeCurrencyComma()}',
                            style: interRegularSmall.copyWith(color: MyColor.colorBlack,fontSize: Dimensions.fontSmall12, fontWeight: FontWeight.w600)),
                      ],
                    ),
                    const SizedBox(width: 10,),
