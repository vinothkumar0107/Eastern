                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: Dimensions.space5),
                        Text('${controller.currencySymbol}${controller.getDepositAmount(widget.index).makeCurrencyComma(precision: 2)}',
                    ...
                    Column(
                      ...
                      children: [
                        Text(MyStrings.perInstallment,
                            style: interRegularSmall.copyWith(color: MyColor.smallTextColor1, fontSize: Dimensions.fontSmall12, fontWeight: FontWeight.w400)),
                        const SizedBox(height: Dimensions.space5),
                        Text('${controller.currencySymbol}${Converter.roundDoubleAndRemoveTrailingZero(controller.planList[widget.index].perInstallment??'').makeCurrencyComma(precision: 2)}',
                            style: interRegularSmall.copyWith(color: MyColor.colorBlack,fontSize: Dimensions.fontSmall12, fontWeight: FontWeight.w600)),
                      ],
                    ),
                    const SizedBox(width: 15,),
                    ...
                    Column(
                      ...
                      children: [
                        Text(MyStrings.youWillGet,
                            style: interRegularSmall.copyWith(color: MyColor.smallTextColor1, fontSize: Dimensions.fontSmall12, fontWeight: FontWeight.w400)),
                        const SizedBox(height: Dimensions.space5),
                        Text('${controller.currencySymbol}${Converter.formatNumber(controller.planList[widget.index].finalAmount??'').makeCurrencyComma(precision: 2)}',
                            style: interRegularSmall.copyWith(color: MyColor.colorBlack,fontSize: Dimensions.fontSmall12, fontWeight: FontWeight.w600)),
                      ],
                    ),
                  ],
